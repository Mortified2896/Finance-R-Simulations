...
# Rebuild Medium image download queues and download missing thumbnail/body images.
# Intended to be called by 01_manual_tools/images/download_missing_medium_images.command.
...
if [[ -t 0 ]]; then
  ...
  echo "Double-click the matching .command file in Finder to review or change settings before starting."
  exit 0
fi
