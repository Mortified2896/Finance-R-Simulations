...
echo "When you open a Medium /tag/... page, /tag/.../recommended page, or article page, tracking starts."
echo "Press Ctrl+C in this Terminal window to stop the watcher."
echo
...
node scripts/watch_medium_tag_page_pw.js \
