article_lab_css <- function() {
  v2_css <- if (get0("article_lab_design_v2", inherits = TRUE, ifnotfound = FALSE)) {
    c(
      ...
      "        border-color: #d9dee3;",
      "      }",
      "      .app-shell-v2 .sidebar { padding: 18px 16px; }",
      "      .app-shell-v2 .guide {",
      "        position: sticky;",
      "        top: 56px;",
      "        align-self: start;",
      ...
      "      .app-shell-v2 .nav-subtitle { font-size: 11px; color: #69737c; }",
...
article_lab_js <- function(is_dimension_mode_value = get0("is_dimension_mode", inherits = TRUE, ifnotfound = FALSE)) {
  HTML(paste0(
      ...
      "        const v2WideSections = ['research_inbox', 'generate', 'api_scoring', 'subtitle_generation', 'thumbnails', 'outline', 'full_text', 'review_publish', 'settings'];",
