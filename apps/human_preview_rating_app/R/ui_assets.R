article_lab_css <- function() {
  v2_css <- if (get0("article_lab_design_v2", inherits = TRUE, ifnotfound = FALSE)) {
    c(
      ...
      "      .title-project-card { border-left: 4px solid #1a8917 !important; }",
      "      .title-project-card .lab-section-header { margin-bottom: 14px; }",
      ...
      "        background: #f7fbf7;",
      "      }",
      "      .title-project-summary h4 { margin: 0 0 6px; font-size: 18px; }",
      "      .title-project-summary p { margin: 0; line-height: 1.55; }",
      "      .title-context-fieldset { margin: 0; padding: 0; border: 0; }",
      "      .title-context-fieldset legend { margin-bottom: 4px; font-size: 15px; font-weight: 760; }",
      "      .title-context-choice-grid {",
      "        display: grid;",
      ...
      "        background: #ffffff;",
      "      }",
      "      .title-context-choice .checkbox { margin: 0 0 4px; }",
      "      .title-context-choice .checkbox label { font-weight: 740; }",
      "      .title-context-choice p { margin: 0; color: #69737c; font-size: 12px; line-height: 1.4; white-space: pre-line; }",
      "      .title-context-choice.is-empty { background: #fafafa; }",
      "      .title-context-choice.is-empty p { font-style: italic; }",
      "      .title-effective-prompt { max-height: 440px; overflow: auto; white-space: pre-wrap; }",
      "      @media (max-width: 900px) { .title-context-choice-grid { grid-template-columns: 1fr; } }",
