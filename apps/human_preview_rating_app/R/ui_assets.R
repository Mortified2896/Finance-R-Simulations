article_lab_css <- function() {
  ...
  HTML(paste(c(
    ...
    "        margin-top: 10px;",
    "      }",
    "      .lab-manual-subtitle > summary {",
    "        cursor: pointer;",
    "        color: var(--ink);",
    "        font-size: 15px;",
    "        font-weight: 700;",
    "      }",
    "      .lab-manual-subtitle[open] > summary {",
    "        margin-bottom: 12px;",
    "      }",
    "      .lab-manual-subtitle .lab-section-copy {",
    "        margin-bottom: 12px;",
    "      }",
    "      .lab-manual-subtitle-grid {",
    "        grid-template-columns: minmax(0, 1fr);",
    "        gap: 14px;",
    "      }",
    "      .lab-manual-subtitle-grid textarea.form-control {",
    "        min-height: 150px;",
    "        resize: vertical;",
    "      }",
    "      .lab-prompt-preview {",
    ...
    "        .lab-generation-controls { grid-template-columns: 1fr; }",
...
article_lab_js <- function(is_dimension_mode_value = get0("is_dimension_mode", inherits = TRUE, ifnotfound = FALSE)) {
  HTML(paste0(
      ...
      "      });",
        ...
        "        const guide = document.querySelector('.guide');",
        "        const wideSections = ['research_inbox', 'summary', 'article_evidence', 'title_lab', 'generate', 'api_scoring', 'subtitle_generation', 'thumbnails', 'outline', 'full_text', 'review_publish'];",
      ...
      "        const verificationTitle = event.target && event.target.closest ? event.target.closest('.dimension-verification-title') : null;",
        ...
        "      }",
        "      function articleLabSetSelectState(message) {",
        "        const select = document.getElementById(message.id);",
        "        if (!select) return;",
        "        select.disabled = Boolean(message.disabled);",
        "        const wrapper = select.closest('.form-group') || select.parentElement;",
        "        if (wrapper) wrapper.classList.toggle('disabled', Boolean(message.disabled));",
        "      }",
        ...
        "        Shiny.addCustomMessageHandler('articleLabSetSelectState', articleLabSetSelectState);",
        "      } else {",
