...
article_lab_js <- function(is_dimension_mode_value = get0("is_dimension_mode", inherits = TRUE, ifnotfound = FALSE)) {
  HTML(paste0(
      ...
      "      });",
        ...
        "        const guide = document.querySelector('.guide');",
        "        const v2Shell = appShell && appShell.classList.contains('app-shell-v2');",
        "        const legacyWideSections = ['research_inbox', 'api_scoring', 'subtitle_generation', 'thumbnails'];",
        "        const v2WideSections = ['research_inbox', 'summary', 'article_evidence', 'title_lab', 'generate', 'api_scoring', 'subtitle_generation', 'thumbnails', 'outline', 'full_text', 'review_publish', 'settings'];",
        "        const wideSections = v2Shell ? v2WideSections : legacyWideSections;",
