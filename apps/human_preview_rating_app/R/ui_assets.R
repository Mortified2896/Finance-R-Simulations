article_lab_css <- function() {
  ...
  HTML(paste(c(
    ...
    "        max-width: 760px;",
    "      }",
    "      #research_summary_evidence_side_panel {",
    "        position: sticky;",
    "        top: 18px;",
    "        z-index: 3;",
    "      }",
    "      .research-evidence-side-panel {",
    "        position: static;",
    "        width: auto;",
    ...
    "        overflow: hidden;",
    "      }",
    "      .research-evidence-side-panel-empty {",
    "        box-shadow: none;",
    "      }",
    "      .research-evidence-side-panel-header {",
    "        display: flex;",
    "        align-items: center;",
    "        justify-content: space-between;",
    "        gap: 14px;",
    ...
    "        #research_summary_evidence_side_panel { position: static; }",
    "        .research-evidence-side-panel {",
    "          position: static;",
    "          width: auto;",
    "          max-height: none;",
...
article_lab_js <- function(is_dimension_mode_value = get0("is_dimension_mode", inherits = TRUE, ifnotfound = FALSE)) {
  HTML(paste0(
      ...
      "        const evidenceDrawer = document.querySelector('.research-evidence-side-panel');",
      "        const evidenceMarker = event.target && event.target.closest ? event.target.closest('.research-citation-marker') : null;",
      "        const insideEvidenceDrawer = event.target && event.target.closest ? event.target.closest('.research-evidence-side-panel') : null;",
      "        if (evidenceDrawer && !evidenceMarker && !insideEvidenceDrawer && window.Shiny && Shiny.setInputValue) {",
