...
article_lab_js <- function(is_dimension_mode_value = get0("is_dimension_mode", inherits = TRUE, ifnotfound = FALSE)) {
  HTML(paste0(
      ...
      "      });",
        ...
        "        const v2WideSections = ['idea_inbox', 'research_inbox', 'summary', 'article_evidence', 'title_lab', 'generate', 'api_scoring', 'subtitle_generation', 'thumbnails', 'outline', 'full_text', 'review_publish', 'settings'];",
